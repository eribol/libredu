...
pub fn root() -> impl Element {
    Column::new()
        ...
        .item(tabs())
        .item_signal(page().signal_cloned().map(|p| match p {
...
pub fn schools_view() -> impl Element {
    Column::new()
        .s(Width::growable())
        .item(search_bar())
        .item_signal(self::school::school().signal_cloned().map_option(
            |school| self::school::school_view(school).into_raw(),
            || schools().into_raw(),
        ))
}
    ...
    Row::new()
        ...
        .item(
            El::new()
                ...
                .s(Height::exact(30))
                .s(Borders::new()
                    .left(Border::new().width(1))
                    .top(Border::new().width(1))
                    .bottom(Border::new().width(1)))
...
fn schools() -> impl Element {
    Column::new()
        ...
        .items_signal_vec(last_schools().signal_vec_cloned().map(|s| school_row(s)))
}
