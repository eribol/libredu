...
fn is_sent_view() -> impl Element {
    Column::new().item("Reset linki e-posta adresinize gönderildi")
}
pub fn root() -> impl Element {
    Column::new()
        .item_signal(is_sent().signal().map_true(is_sent_view))
        .item_signal(is_sent().signal().map_false(forget_password))
}
