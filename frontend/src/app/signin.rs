...
pub fn registered() -> impl Element {
    Column::new().item(Label::new().label("E-posta adresinize link gönderildi"))
}
pub fn register_view() -> impl Element {
    Column::new()
        ...
        .item_signal(email_error().signal_cloned().map_some(|e| {
            Label::new()
                .s(Font::new()
                    .weight(FontWeight::Number(10))
                    .color(color!("red")))
        ...
        .item_signal(password_error().signal_cloned().map_some(|e| {
            Label::new()
                .s(Font::new()
                    .weight(FontWeight::Number(10))
                    .color(color!("red")))
        ...
        .item_signal(server_error().signal_cloned().map_some(|e| {
            Label::new()
                .s(Font::new()
                    .weight(FontWeight::Number(10))
                    .color(color!("red")))
